require '/home/saji/SOMPAK_4R/som/som'
require 'pp' # to pretty print ruby objects

dataf="./input/gpcp_anom_jja.txt"            # input data, given in SOM format
...
init_mapf="gpcp_spc_vc.init_map"   # Output file containing initial map
                              # in this code, this is the sum of the first
                              # two principal components of the data space

out_mapf="gpcp_spc_vc.fin_map"     # The final SOM map, after training
